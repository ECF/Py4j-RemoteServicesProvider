...
/**
 * All tables in the generated code derive from this class, and add their own
 * accessors.
 */
public class Table {
	 ...
	 *
	 * @param vtable_offset
	 *            An `int` offset to the vtable in the Table's ByteBuffer.
	 ...
	 *
	 * @param offset
	 *            An `int` index into the Table's ByteBuffer containing the relative
	 *            offset.
	 ...
	 * which is not very efficient. Instead, each FlatBuffer string also comes with
	 * an accessor based on __vector_as_bytebuffer below, which is much more
	 * efficient, assuming your Java program can handle UTF-8 data directly.
	 *
	 * @param offset
	 *            An `int` index into the Table's ByteBuffer.
	 ...
	 * @param offset
	 *            An `int` index into the Table's ByteBuffer.
	 * @return Returns the start of the vector data whose offset is stored at
	 *         `offset`.
	 */
	 ...
	 * but does not actually copy the data, it still refers to the same bytes as the
	 * original ByteBuffer. Also useful with nested FlatBuffers, etc.
	 *
	 * @param vector_offset
	...
	/**
	 * Initialize any Table-derived type to point to the union at the given
	 * `offset`.
	 *
	 * @param t
	 ...
	 *
	 * @param bb
	 *            A {@code ByteBuffer} to check if it contains the identifier
	 *            `ident`.
	 * @param ident
	 *            A `String` identifier of the FlatBuffer file.
	 ...
	 * @param bb
	 *            A {@code ByteBuffer} to get the tables.
	 */
	 ...
	 * @param bb
	 *            A {@code ByteBuffer} to get the keys.
	 */
	 ...
	 * @param bb
	 *            A {@code ByteBuffer} to get the strings.
	 */
	 ...
	 * @param bb
	 *            A {@code ByteBuffer} to get the first string.
	 */
