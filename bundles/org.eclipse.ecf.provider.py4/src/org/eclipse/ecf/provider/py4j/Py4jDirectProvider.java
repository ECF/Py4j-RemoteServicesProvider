...
public class Py4jDirectProvider extends AbstractDirectProvider implements RemoteServiceAdminListener {
	...
	private GatewayServerListener gatewayServerListener = new GatewayServerListener() {
		...
		public void connectionStarted(Py4JServerConnection arg0) {
			synchronized (getLock()) {
				if (Py4jDirectProvider.this.connection != null)
					logError("connectionStarted error: Already have connection=" + Py4jDirectProvider.this.connection
							+ ".  New connectionStarted=" + arg0);
				Py4jDirectProvider.this.connection = arg0;
			}
		}
		...
		public void connectionStopped(Py4JServerConnection arg0) {
			synchronized (getLock()) {
				...
				else if (Py4jDirectProvider.this.connection != arg0)
