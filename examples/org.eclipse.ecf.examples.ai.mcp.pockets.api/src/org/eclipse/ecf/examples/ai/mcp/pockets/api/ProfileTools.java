...
public interface ProfileTools extends ToolGroupService {
	...
	String exportProfile(
			@ToolParam(description = "previously given name or id for the profile to export") String nameOrId);
	...
	String removeProfile(
			@ToolParam(description = "previously given name or id for the profile to remove") String nameOrId);
